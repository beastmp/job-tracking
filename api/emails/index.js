// This file serves as a dedicated endpoint for /api/emails in Vercel
...
// Use email routes without the /api/emails prefix since Vercel adds that based on the file path
app.use('/', emailRoutes);
